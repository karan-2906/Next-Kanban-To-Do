...
const Hero = () => {
    return (
        <div className="bg-[url('/bg.jpeg')] h-[102vh] relative w-full bg-cover mt-[-75px] overflow-hidden text-white">
            <div className="flex h-full items-center mx-auto justify-center pt-[82px] gap-20 w-[90%] max-w-[1450px]">
                <div className="grid items-center gap-6 md:grid-cols-2">
                    ...
                    <div className="flex flex-col justify-center max-md:items-center space-y-4 max-md:text-center">
                        <div className=" space-y-2 ">
                            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Visualize Success Daily</h2>
